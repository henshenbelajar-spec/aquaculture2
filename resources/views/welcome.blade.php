...
<head>
    ...
    <meta name="description"
        content="AquaSmart — Next-gen precision aquaculture technology. Monitor water quality, oxygen, and temperature in real time.">
...
<body
    ...
    <main id="main-content">
        ...
        <section class="relative w-full overflow-hidden flex flex-col items-center min-h-[90vh] lg:min-h-screen">
            ...
            <div
                ...
                <div
                    ...
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel border border-white/10 text-xs font-semibold text-[#00F0FF] mb-8 uppercase tracking-wider backdrop-blur-md">
        ...
        <section id="features" class="w-full py-24 z-10">
            <div class="max-w-7xl mx-auto px-6 md:px-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    <!-- Feature Card 1 -->
                    <div
                        class="float-card glass-panel rounded-3xl p-8 flex flex-col justify-start relative overflow-hidden group reveal-up reveal-delay-100 glow-border">
                        ...
                        <div class="w-14 h-14 rounded-2xl glass-panel bg-[#44A2F0]/20 flex items-center justify-center border border-[#44A2F0]/30 mb-6 group-hover:bg-[#00F0FF]/20 transition-colors"
                            aria-hidden="true">
                        ...
                        <div class="flex gap-3 mb-4 mt-auto">
                            <div
                                class="inner-block px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-xs font-semibold text-zinc-400 flex items-center gap-2">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#00F0FF]" aria-hidden="true"></span> Sensor
                                1
                            </div>
                            <div class="inner-block px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-xs font-semibold text-zinc-400 flex items-center gap-2"
                                ...
                                <span class="w-1.5 h-1.5 rounded-full bg-[#44A2F0]" aria-hidden="true"></span> Node
                                Basic
                            </div>
                        </div>
                        <div class="w-full h-[1px] bg-gradient-to-r from-white/10 to-transparent" aria-hidden="true">
                        </div>
                    </div>

                    <!-- Feature Card 2 -->
                    <div
                        class="float-card glass-panel rounded-3xl p-8 flex flex-col justify-start relative overflow-hidden group reveal-up reveal-delay-200">
                        <div class="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity"
                            aria-hidden="true">
                            <svg class="w-24 h-24 text-[#00F0FF]" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" aria-hidden="true">
                        ...
                        <div class="flex gap-3 mb-4 mt-auto">
                            <div
                                class="inner-block px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-xs font-semibold text-zinc-400 flex items-center gap-2">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#00F0FF]" aria-hidden="true"></span> Node
                                Guest
                            </div>
                            <div class="inner-block px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-xs font-semibold text-zinc-400 flex items-center gap-2"
                                style="transition-delay: 50ms;">
                    ...
                    <!-- Feature Card 3 -->
                    <div
                        class="float-card glass-panel rounded-3xl p-8 flex flex-col justify-start relative overflow-hidden group reveal-up reveal-delay-300 glow-border">
                        <div class="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity"
                            aria-hidden="true">
                            <svg class="w-24 h-24 text-[#00F0FF]" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" aria-hidden="true">
                        ...
                        <div class="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                            <div class="glass-panel px-4 py-2 rounded-xl border border-white/20 backdrop-blur-md">
                                ...
                                <div class="text-2xl font-bold text-white tracking-tight">24.5<span
                                        class="text-sm font-normal text-zinc-400">°C</span></div>
                            </div>
                            <a href="#"
            ...
            <div class="max-w-7xl mx-auto px-6 md:px-12">
                <div class="flex flex-col lg:flex-row items-end justify-between gap-8 mb-16 reveal-up">
                    <div class="max-w-2xl text-center lg:text-left">
                        <h2 class="text-3xl md:text-5xl font-bold text-white mb-4">Precision <span
                                class="text-[#00F0FF]">Biometrics</span></h2>
                        <p class="text-zinc-500">Monitor health data and growth coefficients with AI-driven telemetry.
                            Every pixel represents a heartbeat of your farm.</p>
                    </div>
                    <div
                        class="hidden lg:flex items-center gap-4 text-xs font-mono uppercase tracking-[0.2em] text-[#00F0FF]/60 bg-[#00F0FF]/5 px-4 py-2 rounded-lg border border-[#00F0FF]/10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Monitor Card 1 -->
                    <div
                        class="float-card glass-panel p-6 rounded-2xl border border-white/5 reveal-up reveal-delay-100">
                        ...
                        <div class="text-3xl font-bold text-white mb-4 tracking-tighter">0.85<span
                                class="text-sm font-normal text-zinc-500 ml-1">cm/day</span></div>
                        <div class="meter-bar mb-1">
                            <div class="meter-fill" style="--fill-level: 85%"></div>
                        </div>
                    ...
                    <!-- Monitor Card 2 -->
                    <div
                        class="float-card glass-panel p-6 rounded-2xl border border-white/5 reveal-up reveal-delay-200">
                        <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="text-3xl font-bold text-white mb-4 tracking-tighter">9.2<span
                                class="text-sm font-normal text-zinc-500 ml-1">mg/L</span></div>
                        <div class="meter-bar mb-1">
                            <div class="meter-fill" style="--fill-level: 92%"></div>
                        </div>
                        <div class="flex justify-between text-[10px] text-zinc-600 font-mono mt-2">
                    ...
                    <!-- Monitor Card 3 -->
                    <div
                        class="float-card glass-panel p-6 rounded-2xl border border-white/5 reveal-up reveal-delay-300">
                        <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="text-3xl font-bold text-white mb-4 tracking-tighter">1.2<span
                                class="text-sm font-normal text-zinc-500 ml-1">kg/m³</span></div>
                        <div class="meter-bar mb-1">
                            <div class="meter-fill" style="--fill-level: 75%"></div>
                        </div>
                        <div class="flex justify-between text-[10px] text-zinc-600 font-mono mt-2">
                            <span>BATCH #822</span>
                            <span>98.6% EFF.</span>
                    ...
                    <!-- Monitor Card 4 -->
                    <div
                        class="float-card glass-panel p-6 rounded-2xl border border-white/5 reveal-up reveal-delay-400">
                        <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="text-3xl font-bold text-white mb-4 tracking-tighter">102.4<span
                                class="text-sm font-normal text-zinc-500 ml-1">kPa</span></div>
                        <div class="meter-bar mb-1">
                            <div class="meter-fill" style="--fill-level: 65%; background: #F04444"></div>
                        </div>
        ...
        <!-- BioMetric Monitoring Section (Original Stable Theme) -->
        <section id="biometrics" class="w-full py-24 z-10 relative overflow-hidden">
